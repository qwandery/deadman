# DeadMan — v1.1 (Archived)

> **Archived.** Superseded by `SPECIFICATION.md` (v1.2.0). Retained for historical reference and migration guidance. The current specification lives at the repository root.

> **Migration:** see `MIGRATION.md` for a worked v1.1 → v1.2.0 manifest conversion.
